...
const ToolButton: React.FC<{
    ...
    <button
        ...
        className={`${baseButtonClass} ${active ? activeButtonClass : ''} ${
            theme === 'dark'
                ? 'text-[#D0D5DD] hover:bg-[#1F2430] hover:text-white'
...
const ToolGroupButton: React.FC<{
    ...
    return (
        <div className="relative" ref={wrapperRef}>
            ...
            {open && (
                <div
                    className={`absolute left-full top-0 ml-2.5 flex flex-col gap-1.5 rounded-[22px] border p-1.5 shadow-[0_20px_44px_rgba(15,23,42,0.16)] ${
        ...
        () => [
            ...
            },
            {
                ...
                icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="m15 5 4 4" />
                        <path d="M12 8 4 16l-1 5 5-1 8-8" />
                    </svg>
                ),
            },
            {
                ...
                icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <ellipse cx="12" cy="11" rx="7.5" ry="5" strokeDasharray="3 3" />
                        <path d="M15 16c0 2-1 3-2.5 3S10 18 10 17.2" />
                    </svg>
                ),
            },
            {
                ...
                icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="m7 21-4-4 10-10 4 4-10 10Z" />
                        <path d="M14 7 9 2" />
                        <path d="M17 21H7" />
                    </svg>
                ),
    ...
    return (
        ...
        >
            ...
            <ToolButton
                ...
                icon={
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="m4 3 7 17 2.5-7.5L21 10 4 3Z" />
                        <path d="m13 13 6 6" />
                    </svg>
                }
